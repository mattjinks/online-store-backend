...
function seedTestData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let products = [
            { name: 'item0', price: '12.34', category: 'category1' },
            { name: 'item1', price: '56.78', category: 'category1' },
            { name: 'item2', price: '90.12', category: 'category1' },
            { name: 'item3', price: '34.56', category: 'category1' },
            { name: 'item4', price: '78.90', category: 'category1' },
            { name: 'item5', price: '12.34', category: 'category2' },
            { name: 'item6', price: '56.78', category: 'category2' },
            { name: 'item7', price: '90.12', category: 'category2' },
            { name: 'item8', price: '34.56', category: 'category2' },
            { name: 'item9', price: '78.90', category: 'category2' },
        ];
        let orders = [
